...
crates/
  ...
  alms-runtime/       # Agent loop (shared by top-level agents and subagents)
                      ...
                      #   context/ — ContextBuilder (token-budgeted context window)
